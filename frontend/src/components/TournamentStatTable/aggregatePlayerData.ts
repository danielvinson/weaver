  ...
  data.map((matchPlayerData) => {
    if (!(matchPlayerData.id in playerData)) {
      playerData[matchPlayerData.id] = {
        ...
        defuses: [matchPlayerData.defuses],
      ...
      playerData[matchPlayerData.id] = {
        ...
        defuses: [...existingData.defuses, matchPlayerData.defuses],
        ...
        name: matchPlayerData.name,
        plants: [...existingData.plants, matchPlayerData.plants],
