...
import { groupA, groupB } from "../data/boomerSeason4/challengerMatches";
...
const getMatchData = async (matchId: string) => {
  ...
  const data = await import(
    `../data/boomerSeason4/challenger/${matchId}.json`
...
export const BoomerSeason4Challenger = () => {
  ...
  return (
    <div>
      ...
      >
        Boomerants: Season 4 Challenger Stats
      </span>
