...
import { matches } from "../data/rendezvous/championship";
...
const getMatchData = async (matchId: string) => {
  ...
  const data = await import(
    `../data/rendezvous/championship/${matchId}.json`
...
export const RendezvousSeason1Championship = () => {
  ...
  return (
    <div>
      <span style={styles.heading}>
        Rendezvous: Season 1 Championship Stats
      </span>
