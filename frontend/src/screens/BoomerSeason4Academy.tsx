...
import { groupA, playoffs } from "../data/boomerSeason4/academyMatches";
...
const getMatchData = async (matchId: string) => {
  ...
  const data = await import(
    `../data/boomerSeason4/academy/${matchId}.json`
...
export const BoomerSeason4Academy = () => {
  ...
  return (
    <div>
      ...
      >
        Boomerants: Season 4 Academy Stats
      </span>
