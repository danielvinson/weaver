...
import { matches } from "../data/rendezvous/academy";
...
const getMatchData = async (matchId: string) => {
  ...
  const data = await import(
    `../data/rendezvous/academy/${matchId}.json`
...
export const RendezvousSeason1Academy = () => {
  ...
  return (
    <div>
      <span style={styles.heading}>Rendezvous: Season 1 Academy Stats</span>
